                          ...
                          >
                            ...
                            <div className="flex items-center space-x-3">
                              ...
                              <Button
                                variant="ghost"
                                size="sm"
                                onClick={() => handleViewPatientDetail(cita.id)}
                  ...
                  {citasCompletadas.length > 0 ? (
                    <div className="space-y-4">
                      {citasCompletadas.map((cita) => (
                        <div
                          key={cita.id}
                          className="flex items-center justify-between p-3 border border-vet-gray-200 rounded-lg"
                        >
                          <div>
                            <div className="flex items-center space-x-2 mb-1">
                        ...
                        {foundPatients.map((mascota) => {
                          ...
                          return (
                            <div
                              ...
                              onClick={() => {
                                if (ultimaCita) {
                                  handleViewPatientDetail(ultimaCita.id);
                                }
